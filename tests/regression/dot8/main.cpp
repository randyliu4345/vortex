...
int main(int argc, char *argv[]) {
  ...
  uint32_t buf_size_A = size_sq * sizeof(int8_t);
  uint32_t buf_size_B = size_sq * sizeof(int8_t);
  uint32_t buf_size_C = size_sq * sizeof(int32_t);

  std::cout << "input data type: " << Comparator<int8_t>::type_str() << std::endl;
  std::cout << "output data type: " << Comparator<int32_t>::type_str() << std::endl;
