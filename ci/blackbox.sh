...
show_usage()
{
    ...
    echo "Usage: $0 [[--clusters=#n] [--cores=#n] [--warps=#n] [--threads=#n] [--l2cache] [--l2mesh] [--l2socket] [--l3cache] [[--driver=#name] [--app=#app] [--args=#args] [--debug=#level] [--scope] [--saif] [--perf=#class] [--log=logfile] [--nohup] [--help]]"
}
...
parse_args() {
    ...
    for i in "$@"; do
        case $i in
            ...
            --l2socket) CONFIGS=$(add_option "$CONFIGS" "-DL2_SOCKET_PRIVATE") ;;
